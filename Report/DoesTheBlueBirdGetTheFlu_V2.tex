...
Repeating the calculations described above using number of Twitter users instead of number of tweets yields similar results (Figures~\ref{fig:tweets_state_full_user}, \ref{fig:tweets_state_full_scatter_user}, \ref{fig:tweets_state_full_scatter_user_log}, and \ref{fig:tweets_state_healthy_sick_user}; $p$ = 0.0823).\newpage
...
This document was generated on August 16, 2017 at 15:38.
