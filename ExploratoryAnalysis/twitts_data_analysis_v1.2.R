...
# # tweets on maps using scatterplots---- #deprecated > check v1.1 for running version -----
  ...
  #using hexbinplot
  hexbin_plot_plus(df,tag="sick_continent",path="plots/",xbins=1000)
  hexbin_plot_plus(df,tag="sick_continent",path="plots/",xbins=500)
  hexbin_plot_plus(df,tag="sick_continent",path="plots/",xbins=300)
  hexbin_plot_plus(df,tag="sick_continent",path="plots/",xbins=100)

  hexbin_plot_plus(df,tag="sick_EastCoast",coord = c(-80,-66,38,43),path="plots/",xbins=1000)
  hexbin_plot_plus(df,tag="sick_EastCoast",coord = c(-80,-66,38,43),path="plots/",xbins=500)
  hexbin_plot_plus(df,tag="sick_EastCoast",coord = c(-80,-66,38,43),path="plots/",xbins=300)
  hexbin_plot_plus(df,tag="sick_EastCoast",coord = c(-80,-66,38,43),path="plots/",xbins=100)
