...
summarise_flu <- function(datatable,cdc_data,start=as.Date("2011-03-05"),end=as.Date("2015-02-28"),coord=c(-125,-66,25,50),path="",nat_reg="state",tag=""){
  ...
  plot_flu_states(flu_aggregated,filename=paste0(nat_reg,"_twitter_flu_",tag,".avi"),nat_reg)
  plot_flu_states(cdc_data,filename=paste0(nat_reg,"_cdc_flu_",tag,".avi"),nat_reg)
  ...
  plot_flu_states(merged_set,filename=paste0(nat_reg,"_Twitter_cdc_diff_",tag,".avi"),nat_reg,diff=T)
