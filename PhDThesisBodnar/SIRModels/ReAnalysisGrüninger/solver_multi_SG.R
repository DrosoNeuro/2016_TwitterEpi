...
gammas = 3^seq(gamma_center_adjusted - 10*5^-step, gamma_center_adjusted + 10*5^-step, length.out = 50)

Rnaughts = seq(max(1.0,rnaught_center - 10*2^-(1+step)),rnaught_center + 10*2^-(1+step),length.out=50)
